package com.community.config.security.dsl;
...
import com.community.config.security.filter.RestAuthenticationFilter;
...
public class RestApiDsl<H extends HttpSecurityBuilder<H>>
	...
	public void configure(H http) {
		...
		getAuthenticationFilter().setSecurityContextRepository(
				getAuthenticationFilter().getSecurityContextRepository((HttpSecurity) http));
